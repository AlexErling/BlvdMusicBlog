class PostsController < ApiController
  ...
  before_action :authenticate_user!, except: [:index, :show, :search, :user_search]
  ...
  def post_params
    params.require(:post).permit(:title, :body, :post_name, :post_type, :user_id, :link, :tag_list, :image, :url_slug)
  end
